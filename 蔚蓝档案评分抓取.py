...
while True:
    try:
        ...
        print("B站评价 " + str(Bili_ba_api) + "分  " "评价人数 " + str(Bili_ba_api1) + "  显示人数 " + str(Bili_ba_api2))
        ...
        # 定义CSV文件的字段名称
        field_names = ['时间', 'Bilibili评分', '评价人数', '1星', '2星', '3星', '4星', '5星']  # 表头
        file_write = [minute, Bili_ba_api, Bili_ba_api1, stra_1, stra_2, stra_3, stra_4, stra_5]  # 写入变量数据
