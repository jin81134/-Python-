...
file_name = parent_dir + r'\数据\蔚蓝档案评分抓取_B站.csv'
output_name = parent_dir + r'\Bili评分.html'
...
# 设置图形的标题和坐标轴标签
fig.update_layout(title="Bili评分<br>双击右侧图例可以打开单条折线，点击右上工具可缩放", xaxis_title="时间", yaxis_title="评分人数")
